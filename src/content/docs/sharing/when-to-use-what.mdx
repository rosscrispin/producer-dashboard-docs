...
A share link is temporary by nature — it's a snapshot of your track at a specific moment. If you update the track later, existing share links still point to the original version.
