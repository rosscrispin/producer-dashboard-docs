...
When you share a track with someone outside your collaboration circle using a public share link, they can view comments you've marked for external visibility. This is useful when sharing with artists, managers, or labels who need to review feedback but don't have full project access.

External viewers see a read-only version of comments — they cannot add replies or edit existing feedback.
