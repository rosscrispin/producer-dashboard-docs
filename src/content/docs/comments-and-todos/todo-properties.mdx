...
- **You created it or it's assigned to you** — you can edit all properties
- **Someone else created it and assigned it to them** — you can only mark it complete or change the workflow stage
