...
Your subscription plan determines three key resource ceilings:
...
- **Storage limits** — how much audio and project file storage you have available

These limits reset monthly for recurring plans, while lifetime plans provide permanent access to your tier's resources. When you approach or reach a limit, the app displays clear indicators so you can manage your usage before running into walls.
...
| Plan | Maximum Tracks |
|------|----------------|
| Free | Limited to 3 tracks |
| Starter | Up to 50 tracks |
| Pro | Up to 200 tracks |
| Lifetime | Unlimited tracks |
...
|------|-----------------------|
| Free | No collaborators allowed |
| Starter | Up to 3 collaborators |
| Pro | Up to 10 collaborators |
| Lifetime | Up to 10 collaborators |
