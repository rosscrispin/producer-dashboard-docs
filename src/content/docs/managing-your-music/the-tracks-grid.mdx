...
|--------|---------------|
| **Song Name** | The track's display name (like "Summer Vibes v3 Final Mix") derived from your latest bounce or project file |
| **Stage** | Your current workflow stage — Idea, Editing, Ready to Post, Published, and any custom stages you've created |
...
The Song Name column shows a friendly, readable version of your track — "Late Night Groove V3" instead of "late_night_groove_v3_final_001.wav". This name is automatically derived from your most recently modified bounce or project file.
