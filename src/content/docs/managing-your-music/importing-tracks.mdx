...
You'll find the import option in the toolbar at the top of the Tracks page. Click the **Import Files** button to open the dialog.

The first time you import, you'll see a welcome message explaining the basics. On subsequent visits, the dialog opens directly to the file selection area.

You can also close the dialog by clicking the X button, pressing Escape, or clicking outside the dialog window.

---

## Selecting Files to Import

The import dialog has two main buttons for adding files:

- **Add Bounces** — Use this for audio files like WAV, MP3, AIFF, FLAC, and M4A
- **Add Projects** — Use this for project files like Ableton Live sets (.als), Logic Pro (.logicx), FL Studio (.flp), and others

When you click either button, a file picker opens. For bounces and stems, you can select multiple files at once. For projects, you select project folders (the app includes any related files in that folder).
...
- **Purple** — Stems (individual instrument tracks)
...
- **Organize your inbox folders first** — Keep bounces, stems, and projects in separate folders before importing. The app reads these folders and categorizes files accordingly.
