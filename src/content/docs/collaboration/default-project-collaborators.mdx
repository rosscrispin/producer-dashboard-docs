...
:::note
The automatic default collaborator feature (pre-assigning collaborators to all new tracks in a project) may not be available in all versions of the app. If you don't see a "Default Collaborators" option in your project settings, use the Collaborators widget to add collaborators to tracks individually.

The split allocation guidance on this page applies to all collaborator management.
:::
