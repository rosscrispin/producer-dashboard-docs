...
When inviting a collaborator, you choose their access level — essentially, how much control they have over the project:

**Full Access**
Collaborators can edit the track, adjust their own split allocations, and invite other collaborators. Use this for producers, co-writers, or trusted creative partners who need to make decisions.

**Edit Only**
Collaborators can modify the track but cannot change collaborator settings or invite new team members. This works well for mix engineers or session musicians who contribute to the work without needing administrative control.

**View Only**
Collaborators can see the track, its details, and any shared files — but they cannot make any changes. Great for managers, A&R representatives, or anyone who needs to stay informed without editing permissions.

### Choosing Access Levels

Match access levels to what each person actually needs to do. A mixing engineer needs edit access to do their job. A songwriter may only need to view progress and leave feedback. A manager might just want visibility without touching anything. Giving people the minimum access they need keeps your project secure while still enabling smooth collaboration.
...
A collaborator with view-only access sees the track but cannot open editing panels or modify anything. Someone with edit access can make changes but won't see options to manage other collaborators.
