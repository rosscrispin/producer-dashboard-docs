...
5. Set their **master split** and **publishing split** percentages
6. Choose their permission level (View, Comment, Download, Edit)
7. Click **Save**
...
When you share a track, you need to decide how ownership and royalties get divided. Producer Dashboard tracks two types of splits:
...
Both splits are expressed as percentages. The total for each split type must equal 100% across all collaborators (including you as the track owner).
...
The app splits both master and publishing percentages evenly. If the math doesn't divide evenly (like splitting 100% among three people), it rounds to two decimal places with the remainder going to the last collaborator.
...
- Their master and publishing splits
...
If you regularly work with the same producers or engineers, you can set them as **default project collaborators**. When you create a new track in that project, they're automatically added with your saved split preferences.

This saves time when starting new tracks with your usual team. Default collaborators can be configured per project from the project settings page.
...
- [Splits & Rights](/collaboration/splits-and-rights) — deep dive into master and publishing splits
