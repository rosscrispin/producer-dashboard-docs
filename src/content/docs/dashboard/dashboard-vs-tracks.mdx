...
- **Mini Kanban** — a compact board showing your tracks grouped by workflow stage (Idea, Editing, Ready to Post, Published, and so on)
...
:::tip
The Mini Kanban isn't just for viewing — you can drag tracks between columns to change their stage. This is often faster than opening individual tracks to update their status, especially when you're moving several songs through the same workflow step.
:::
